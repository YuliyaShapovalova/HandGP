...
print(df[df['Dose1']==0]['Dose2'].to_numpy().reshape(-1,1).astype(float))
...
plt.savefig('figures/Greco_3by6/Greco'+'JointFit'+'.png')
...
plt.ylabel('Response', fontsize=40)
plt.xlabel('$log(x_1+l_1)$', fontsize=40)
#plt.title('Dose-response curve')
plt.tick_params(axis='both', which='major', labelsize=40)
...
plt.ylabel('Response', fontsize=40)
plt.xlabel('$log(x_2+l_2)$', fontsize=40)
plt.tick_params(axis='both', which='major', labelsize=40)
plt.savefig('figures/Greco_3by6/Greco'+'DrugB_in_log'+'.png', bbox_inches="tight")
...
print('dim2', dim2_A_lower)
print('dim2',dim2_B_lower)

print('dim2',dim2_A_upper)
print('dim2',dim2_B_upper)
...
print(Y_expected_Hand)
print(Y_expected_Hand_lower)
print(Y_expected_Hand_upper)
...
plt.savefig('figures/Greco_3by6/Greco_contour_result'+'.png',bbox_inches = 'tight',
    pad_inches = 0)
...
plt.savefig('figures/Greco_3by6/Greco_Hand_contour_result'+'.png',bbox_inches = 'tight',
    pad_inches = 0)
...
v = np.linspace(0.0, 120.0, 10, endpoint=True)
#ax.set_aspect('equal')
cf = ax.contourf(Dose_A.flatten(), Dose_B.flatten(),Y_expected_Hand_lower, v)
cbar = fig.colorbar(cf, ax=ax)
...
plt.ylabel('$x_2$', fontsize=20)
#plt.title("Hand-GP estimated surface", fontsize=20)
plt.savefig('figures/Greco_3by6/Greco_Hand_contour_result_lower'+'.png',bbox_inches = 'tight',
    pad_inches = 0)
...
v = np.linspace(0.0, 120.0, 10, endpoint=True)
#ax.set_aspect('equal')
cf = ax.contourf(Dose_A.flatten(), Dose_B.flatten(),Y_expected_Hand_upper, v)
cbar = fig.colorbar(cf, ax=ax)
...
plt.ylabel('$x_2$', fontsize=20)
#plt.title("Hand-GP estimated surface", fontsize=20)
plt.savefig('figures/Greco_3by6/Greco_Hand_contour_result_upper'+'.png',bbox_inches = 'tight',
    pad_inches = 0)
...
plt.xlabel('$x_1$', fontsize=20)
plt.ylabel('$x_2$', fontsize=20)
plt.savefig('figures/Greco_3by6/Greco_mean_full_contour_result'+'.png',bbox_inches = 'tight',
    pad_inches = 0)
...
plt.savefig('figures/Greco_3by6/Greco_GP_residuals'+'.png',bbox_inches = 'tight',
    pad_inches = 0)
...
plt.xlabel('$x_1$', fontsize=20)
plt.savefig('figures/Greco_3by6/Greco'+'DrugA'+'.png')
...
plt.ylabel('Response', fontsize=20)
plt.xlabel('$x_1$', fontsize=20)
plt.savefig('figures/Greco_3by6/Greco'+'DrugB'+'.png')
...
def plot_samples(step_size, num_leapfrog, samples, parameters, y_axis_label):
    ...
    plt.xlabel("HMC iteration", fontsize=15)
    plt.ylabel(y_axis_label, fontsize=15)
    plt.savefig('figures/Greco_3by6/greco_samples'+str(step_size)+'_'+str(num_leapfrog)+'.png')
...
def marginal_samples(step_size,num_leapfrog, samples, parameters, y_axis_label):
    ...
    plt.savefig('figures/Greco_3by6/greco_marginal_samples_'+str(step_size)+'_'+str(num_leapfrog)+'.png')
