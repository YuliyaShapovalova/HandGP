...
from utilities import (compute_prior_hyperparameters, trapezoidal_area,  predict_in_observations, fit_Hand, y_exp_Hand, y_exp, find_nearest, K_log, K_multiplicative)
import pymc3
