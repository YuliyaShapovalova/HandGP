...
plt.savefig('figures/ChouTalalay2/'+drug_name+'_DrugA'+'.png')
...
plt.ylim(0.0, 1.1)
plt.tick_params(axis='both', which='major', labelsize=20)
plt.savefig('figures/ChouTalalay2/'+drug_name+'_DrugB'+'.png')
...
plt.savefig('figures/ChouTalalay2/'+str(drug_name)+'_Hand_contour_result'+'.png', bbox_inches = 'tight',
    pad_inches = 0)
...
plt.savefig('figures/ChouTalalay2/'+str(drug_name)+'_GP_mean'+'.png', bbox_inches = 'tight',
    pad_inches = 0)
...
plt.savefig('figures/ChouTalalay2/'+str(drug_name)+'contour_result'+'.png', bbox_inches = 'tight',
    pad_inches = 0)
...
plt.savefig('figures/ChouTalalay2/'+str(drug_name)+'_GP_residuals'+'.png', bbox_inches = 'tight',
    pad_inches = 0)
...
plt.tick_params(axis='both', which='major', labelsize=20)
plt.savefig('figures/ChouTalalay2/ChouTalalay2_GP'+'_diagonal'+'.png')
...
plt.savefig('figures/ChouTalalay2/ChouTalalay2_GP'+'_diagonal_null'+'.png', bbox_inches = 'tight',
    pad_inches = 0)
...
plt.tick_params(axis='both', which='major', labelsize=20)
plt.savefig('figures/ChouTalalay2/ChouTalalay2_GP'+'_diagonal_null_difference'+'.png', bbox_inches = 'tight',
    pad_inches = 0)
...
def plot_samples(step_size, num_leapfrog, samples, parameters, y_axis_label):
    ...
    plt.savefig('figures/ChouTalalay2/ChouTalalay2_samples'+str(step_size)+str(num_leapfrog)+'.png')
...
def marginal_samples(step_size,leap_frog, samples, parameters, y_axis_label):
    ...
    for ax, val, param in zip(axes, samples, parameters):
        ...
        ax.set_title(param_to_name[param])
    fig.suptitle(y_axis_label)
    plt.savefig('figures/ChouTalalay2/ChouTalalay2_marginal_samples_'+str(step_size)+str(num_leapfrog)+'.png')
    #plt.show()
    res = np.zeros((4, 2))
    for i in range(4):
    ...
    print(df)
    df = df.round(2)
    df.to_csv('results/ChouTalalay2/ChouTalalay2_hyperparameters'+str(step_size)+str(leap_frog)+'.csv')
